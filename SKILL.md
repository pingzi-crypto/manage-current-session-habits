...
```powershell
& E:\manage-current-session-habits\scripts\invoke-backend.ps1 -Request "把第1条加到 session_close 场景; intent=close_session"
```
...
```powershell
& E:\manage-current-session-habits\scripts\invoke-backend.ps1 -Request "列出用户习惯短句"
& E:\manage-current-session-habits\scripts\invoke-backend.ps1 -Request "删除用户习惯短句: 收尾一下"
```
